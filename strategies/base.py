...
class BaseStrategy(ABC):
    def __init__(self, config: StrategyConfig):
        ...
        self.performance_metrics = {
            ...
            "winning_trades": 0, "losing_trades": 0, "total_pnl": 0.0, "win_rate": 0.0,
        }
    ...
    def get_performance_metrics(self) -> Dict[str, Any]:
        ...
        return metrics
    def update_performance(self, signal_id_or_pnl=None, pnl_or_side=None, is_winner=None, profit_loss=None, pnl=None, signal_type=None):
